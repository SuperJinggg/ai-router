...
func Load() (*Config, error) {
	...
	postgresDSNFlag := flag.String("postgres-dsn", "", "postgres dsn")
	...
	postgresDSN := pickString(*postgresDSNFlag, os.Getenv("POSTGRES_DSN"), "")
	if postgresDSN == "" {
		return nil, errors.New("POSTGRES_DSN is required (or pass --postgres-dsn)")
	}
